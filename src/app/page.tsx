...
export default function Home() {
  ...
  return (
    <div className="bg-bground grid min-h-screen place-content-center">
      <div className="flex min-h-[41rem] max-w-[68rem] items-center gap-8 rounded-2xl bg-white p-12">
